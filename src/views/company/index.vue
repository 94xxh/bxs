  ...
  <div class="app-container" v-loading="isLoading">
    ...
    <div class="contain-wrap">
        ...
        <el-table ref="multipleTable" stripe border :data="tableData" tooltip-effect="dark" style="width: 100%" :header-cell-style="{background: '#f4f4f4',color: 'black'}" @selection-change="handleSelectionChange">
            <el-table-column prop="company_name" label="公司名" width="120" show-overflow-tooltip></el-table-column>
            <el-table-column prop="des" label="摘要" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="keyword" label="关键词" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="tag" label="标签" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="category_id" label="分类" show-overflow-tooltip>
            </el-table-column>

<template>
  <div class="upload-container">
    ...
    <el-dialog append-to-body :visible.sync="dialogVisible">
      <el-upload class="editor-slide-upload" :data="postData" action="http://m.lifa-air.cn/?s=/Api/System/uploadFile" :multiple="true" :file-list="fileList" :show-file-list="true"
